...
```js
const url = require('url')
let a = url.resolve('/one/two/three', 'four')  ( 注意最后加/ ，不加/的区别 )  
...
<img src="笔记.assets/image-20220213211423142.png" alt="image-20220213211423142" style="zoom:67%;" />

```js
const querystring = require('querystring')
let str = 'id=3&city=北京&url=https://www.baidu.com'
...
```js
const querystring = require('querystring')
let str = 'id%3D3%26city%3D%E5%8C%97%E4%BA%AC%26url%3Dhttps%3A%2F%2Fwww.baidu.com'
...
letws1 = fs.createWriteStream('output1.txt', 'utf-8');
...
![](assets/2023-12-20-14-25-26-image.png)
...
![](assets/2023-12-20-14-26-17-image.png) 
